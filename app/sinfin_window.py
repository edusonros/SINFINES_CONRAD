...
class SinfinWindow(tk.Toplevel):
    def __init__(self, parent, sinfin_id: int, on_updated_callback=None):
        ...
        self.v_002A_ventana_inspeccion = tk.StringVar(value="No")
        self.v_002A_suj_mangon_intermedio = tk.StringVar(value="No")
        self.v_002A_boca_entrada = tk.StringVar(value="Si")
        self.v_002A_boca_salida = tk.StringVar(value="Si")
        ...
        self.v_002A_vi_lleva = tk.StringVar(value="No")   # "" / "Sí" / "No"
        ...
        self.v_002B_ventana_inspeccion = tk.StringVar(value="No")
        self.v_002B_suj_mangon_intermedio = tk.StringVar(value="No")
        self.v_002B_boca_entrada = tk.StringVar(value="Si")
        self.v_002B_boca_salida = tk.StringVar(value="Si")
    ...
    def _build_camisa(self):
        ...
        yesno = ["", "Sí", "No"]
                # --- Defaults / normalización (punto 1) ---
        if not self.v_002A_ventana_inspeccion.get().strip():
            self.v_002A_ventana_inspeccion.set("No")
        if not self.v_002B_ventana_inspeccion.get().strip():
            self.v_002B_ventana_inspeccion.set("No")
    ...
    def _load_definition(self):
        ...
        self.v_002A_ventana_inspeccion.set(
            d.get("002A_ventana_inspeccion", "No"))
        self.v_002A_suj_mangon_intermedio.set(
            d.get("002A_suj_mangon_intermedio", "No"))
        self.v_002A_boca_entrada.set(d.get("002A_boca_entrada", "Si"))
        self.v_002A_boca_salida.set(d.get("002A_boca_salida", "Si"))
        ...
        self.v_002B_ventana_inspeccion.set(
            d.get("002B_ventana_inspeccion", "No"))
        self.v_002B_suj_mangon_intermedio.set(
            d.get("002B_suj_mangon_intermedio", "No"))
        self.v_002B_boca_entrada.set(d.get("002B_boca_entrada", "Si"))
        self.v_002B_boca_salida.set(d.get("002B_boca_salida", "Si"))
